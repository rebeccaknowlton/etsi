...
```
We will go through an example using the main functions in the **etsi** R package. If you are viewing the html version of this tutorial, you can find the R markdown file here: <https://github.com/rebeccaknowlton/etsi>, it is the file called etsi_tutorial.Rmd. First, install the package from CRAN, and load the package.
...
```{r}
exampledataA.nodelta = exampledataA[,!names(exampledataA) %in% "delta"]
